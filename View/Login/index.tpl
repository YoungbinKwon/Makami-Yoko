          ...
          <ul class="nav-items-container">
            ...
            <li data-nav-item-id="page-1" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
              <a href="#page-1" class="block-keep-ratio-content box-nav-item-link">
                <span class="box-text box-text-nav-item flexbox-center">Yoko-chan</span>
              </a>
            </li>
            ...
            <li data-nav-item-id="page-2" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
              <a href="#page-2" class="block-keep-ratio-content box-nav-item-link">
                <span class="box-text box-text-nav-item flexbox-center">Search</span>
              </a>
            </li>
      ...
      <div class="content-wrapper js-content-wrapper">
        ...
        <section data-page-id="page-1" class="content js-content">
          ...
          <header class="box box-black margin-b-20">
            <h2 class="box-text page-title-text">Hello Yoko-chan</h2>
          </header>
          ...
          <div class="content-text chose-user">
            <p class="user-text">Please chose your name.</p><br>
            <ul>
              <li>

                <div class="user" >
                  <img src="img/baby_3.png" class="user-img" width=100>
                  New
                </div>
              </li>
              <li><div class="user" >
                ...
                <ul>
                  ...
                  <li>
                    Number of playing : 10
                  </li>
                  <li>
                    Average play price : 14,000yen</li>
                </ul>
              ...
              <li>
                <div class="user" >
                  <img src="img/wedding.png"  class="user-img" height=150>
                  Kwon : Lv.10
                </div>
              ...
              <li>
                <div class="user" >
                  <img src="img/baby_4.png" class="user-img margin-t-50 margin-b-20" width=100>
                  Moise : Lv.3\
                </div>
              </li>
            </ul>

            <p class="user-text-under margin-t-50">The baby grows according to the number of times of golf by GORA.<br>
            </p>
          </div>
