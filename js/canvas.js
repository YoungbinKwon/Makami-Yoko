...
// wには文字の大体の横幅を入れる
var createReserveText = function(ctx, text, color, x, y, w) {
    ctx.fillStyle = color;
...
var mokoDraw = function() {
    ...
    var render = function() {
        ...
        createText(ctx, '考え中だよ', 'black', config.cx, config.cy, 120);
...
var mokoReserveDraw = function() {
    ...
    var render = function() {
        ...
        // createCircle(ctx, 'white', 'black', 3, 250, 210, 5);
        createMokomokoFukidashi(config);
        createReserveText(ctx, '予約したよ', 'black', config.cx, config.cy, 110);
